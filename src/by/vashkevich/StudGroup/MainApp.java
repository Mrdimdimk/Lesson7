...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("—редний возраст студентов : " + gr1.avgStudAge()
				+ "г." + " OK");
		System.out.println(" оличество студентов зачисленных в 2015г. : "
				+ gr1.coutStudIn2015());
		System.out
				.println("√од в котором зачисленно максимальное число студентов : "
						+ gr1.nameYearMaxSudentAdd());
		System.out.println(" оличество студентов в этот год : "
				+ gr1.countYearMaxSudentAdd() + " OK");
